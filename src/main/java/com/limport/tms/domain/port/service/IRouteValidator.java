 ...
 * Infrastructure layer provides the implementation that integrates with external routing services.
 */
public interface IRouteValidator {
    ...
    class RouteOptimizationResult {
        ...
        public static RouteOptimizationResult infeasible(String reason) {
            return new RouteOptimizationResult(false, List.of(), 0, 0, null, reason);
        }
        
        public static RouteOptimizationResult success(List<String> waypoints, double distance, long duration, String algorithm) {
            return new RouteOptimizationResult(true, waypoints, distance, duration, algorithm, "Route optimized successfully");
        }
    }
}
