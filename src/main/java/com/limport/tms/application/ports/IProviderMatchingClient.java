    ...
    record CapacityVerificationResponse(
        ...
        public static CapacityVerificationResponse sufficient(double available, double required) {
            return new CapacityVerificationResponse(
                true, available, required, "Capacity available"
            );
        }
        ...
        public static CapacityVerificationResponse insufficient(double available, double required) {
            return new CapacityVerificationResponse(
                ...
                String.format("Insufficient capacity: need %.2fkg, have %.2fkg", required, available)
            );
        }
        
        public static CapacityVerificationResponse unavailable(String message) {
            return new CapacityVerificationResponse(false, 0.0, 0.0, message);
        }
    }
    
    /**
     * Response from PMS provider matching.
     */
